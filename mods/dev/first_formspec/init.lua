...
minetest.register_chatcommand("formspec", {
	func = function(name, param)
		minetest.show_formspec(name, "first_formspec:form",
				"size[9,4]" ..
				"label[0,0;Hello, " .. name .. " ! Bienvenue sur axinite]" ..
				"label[0,0; Nienvenue sur axinite, pour continuer, entre le mot 'coucou' ci dessous et clique sur go pour nous rejoindre !]"..
