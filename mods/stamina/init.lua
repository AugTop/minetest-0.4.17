...
STAMINA_EXHAUST_JUMP = 4	-- .. if jumping
STAMINA_EXHAUST_CRAFT = 15	-- .. if player crafts
STAMINA_EXHAUST_PUNCH = 20	-- .. if player punches another player
STAMINA_EXHAUST_LVL = 180	-- at what exhaustion player saturation gets lowered
...
SPRINT_SPEED = 1.2		-- how much faster player can run if satiated
SPRINT_JUMP = 0.1		-- how much higher player can jump if satiated
SPRINT_DRAIN = 0.30		-- how fast to drain satation while sprinting (0-1)
